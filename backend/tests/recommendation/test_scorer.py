...
from backend.repositories import FangCollaborativeParameterRepository, FangContentBasedRepository, VacancyRepository
from backend.recommendation.scorers import FangCollaborativeScorer, FangContentBasedScorer, FangScorer, FangVacancyScorer
