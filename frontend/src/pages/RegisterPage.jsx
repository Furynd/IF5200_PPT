          ...
          <div className="flex-1 p-8 md:p-10 flex flex-col justify-center">
            ...
            <div className="space-y-3 mb-5">
              ...
              <button
                ...
                disabled={loading || oauthLoading === 'google' || oauthLoading === 'linkedin_oidc'}
                className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-[#0077b5] text-[#0077b5] rounded-lg text-sm font-medium hover:bg-blue-50 transition-colors disabled:opacity-50"
              >
