    ...
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          {infoMessage && (
            <div className="mb-4 bg-blue-50 border border-blue-200 text-blue-700 text-sm px-3 py-2 rounded-lg">{infoMessage}</div>
          )}
          ...
          <div className="space-y-3 mb-4">
            <button
              ...
              type="button"
              disabled={loading || oauthLoading === 'google' || oauthLoading === 'linkedin_oidc'}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-200 rounded-lg text-sm font-medium text-slate-700 hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
            ...
            <button
              ...
              type="button"
              disabled={loading || oauthLoading === 'google' || oauthLoading === 'linkedin_oidc'}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 bg-[#0077b5] text-white rounded-lg text-sm font-medium hover:bg-[#006097] transition-colors disabled:opacity-50"
            >
              <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
              </svg>
              {oauthLoading === 'linkedin_oidc' ? 'Redirecting to LinkedIn...' : 'Continue with LinkedIn'}
            </button>
          </div>
